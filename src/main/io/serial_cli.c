...
const clivalue_t valueTable[] = {
    ...
    { "iterm_throttle_reset",       VAR_UINT16 | PROFILE_VALUE, &masterConfig.profile[0].pidProfile.itermThrottleThreshold, .config.minmax = {0, 1000 } },
    { "iterm_throttle_delta",       VAR_UINT16 | PROFILE_VALUE, &masterConfig.profile[0].pidProfile.itermThrottleThresholdTime, .config.minmax = {0, 1000 } },
